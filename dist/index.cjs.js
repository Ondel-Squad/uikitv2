...
var lightColors = __assign(__assign(__assign({}, baseColors), brandColors), { background: "#FAF9FA", backgroundDisabled: "#E9EAEB", contrast: "#191326", invertedContrast: "#FFFFFF", input: "#eeeaf4", tertiary: "#ffcbde", text: "#f04d92", textDisabled: "#BDC2C4", textSubtle: "#f04d92", borderColor: "#E9EAEB", card: "#ffcbde", gradients: {
        bubblegum: "linear-gradient(139.73deg, #a83569 0%, #91305c 100%)",
    } });
var darkColors = __assign(__assign(__assign({}, baseColors), brandColors), { secondary: "#9A6AFF", background: "#343135", backgroundDisabled: "#3c3742", contrast: "#FFFFFF", invertedContrast: "#191326", input: "#483f5a", primaryDark: "#0098A1", tertiary: "#353547", text: "#f04d92", textDisabled: "#666171", textSubtle: "#f04d92", borderColor: "#524B63", card: "#27262c", gradients: {
